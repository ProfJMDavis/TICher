...
SAY~*Laughs.* This is a strange way to say goodbye, though, isn't it? Over the dead bodies of rats?~
...
++ ~Yes.~ + m5b
++ ~No... I'm just not interested.~ + m5b1
++ ~Maybe. I'll have to think about it.~ + m5b2
END
...
IF ~~ THEN BEGIN m5b1
SAY~Then I'll guess it'll have to be goodbye amongst the dead rodentiae. Here's a little gold for killing those rats for me.~
...
IF ~~ THEN BEGIN m5.2
SAY~Yes... I guess I am crazy. Here's a little gold for killing those rats for me. Have a good life, then, <CHARNAME>.~
IF ~~ THEN DO ~GiveGoldForce(25) AddexperienceParty(50) EscapeArea()~ EXIT
END
