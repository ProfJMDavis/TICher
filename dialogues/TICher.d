...
+~Global("T1CowMoo","GLOBAL",1)~+ ~Apparently, I've acquired a new skill: I'm talking to rats... By Chauntea, I've become a 'Rat-Whisperer'!!~ + m2d
END
...
IF ~~ THEN BEGIN m5b
SAY~Then I'll see you there. Here's a little gold for taking care of those rats for me.~
IF ~~ THEN DO ~GiveGoldForce(25) AddexperienceParty(50) EscapeArea() SetGlobal("TICherYes","GLOBAL",1)~ EXIT
END

IF ~~ THEN BEGIN m5b1
SAY~Then I'll guess it'll have to be goodbye here amongst the rodentiae. Here's a little gold for taking care of those rats for me.~
IF ~~ THEN DO ~GiveGoldForce(25) AddexperienceParty(50) EscapeArea()~ EXIT
END

IF ~~ THEN BEGIN m5b2
SAY~Don't feel pressured to do something you don't want to do. I'll wait there awhile in case you decide you want a last goodbye. If not, fare thee well, <CHARNAME>. Oh! And here's a little gold for taking care of those...ummm...talking rats for me.~
IF ~~ THEN DO ~GiveGoldForce(25) AddexperienceParty(50) EscapeArea() SetGlobal("TICherYes","GLOBAL",1)~ EXIT
END
...
IF ~~ THEN BEGIN m5b1r
SAY~Then I'll guess it'll have to be goodbye here amongst the talking rodentiae. Here's a little gold for taking care of the rats for me.~
IF ~~ THEN DO ~GiveGoldForce(25) AddexperienceParty(50) EscapeArea()~ EXIT
END
...
IF ~~ THEN BEGIN y1c1
SAY~*Cherilane closes her eyes, rubs them briskly, and then opens them again.* I have to find Canticle and leave here. Farewell, my sweet hero. I thought my life was over, but I see now that our destinies are somehow entwined. If I'm lucky, I will have gotten work in the Ducal palace at Baldur's Gate. If I'm not there, look for Geoff. He'll be there and will know where I am.~
IF ~~ THEN DO ~EscapeArea()~ EXIT
END

IF ~~ THEN BEGIN y1d1
SAY~I... I don't know. *Cherilane closes her eyes, rubs them briskly, and then opens them again.* Yessss... I think I'd better go. This place is so horrible! One of the other bards, Canticle, and I hit the road for Baldur's Gate after he got smacked with flying ogre liver. But then Davaeorn's soldiers caught us on the road. He's somewhere in the mines above us... I'll see if I can find him.  Farewell, my sweet hero. I thought my life was over, but I see now that our destinies are somehow entwined. If I'm lucky, I will have gotten work in the Ducal palace at Baldur's Gate. If I'm not there, look for Geoff. He'll be there and will know where I am.~
IF ~~ THEN DO ~EscapeArea()~ EXIT
END
...
SAY~You know, it has struck me how often evil works behind a pleasing form or an affectionate embrace. Be cautious of those who would seek to deceive you in the name of friendship, <CHARNAME>. Even now, my muses call to me. Braig says:
...
IF ~~ THEN BEGIN t5
SAY~*Cherilane kisses you one final time.* You are kind. Farewell, again. If I'm lucky, I will have gotten work in the Ducal palace at Baldur's Gate. If I'm not there, look for Geoff. He'll be there and will know where I am.~
