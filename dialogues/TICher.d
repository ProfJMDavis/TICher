...
CHAIN
IF ~~ THEN TICher n5m1
~*Cherilane pulls away, but looks intently in your eyes.*~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(*She lays her hands on your shoulders, leaning over you, allowing you a full view of her smooth, softly rounded breasts under her low-cut shirt.*)~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(Merciful Oghma, I need to taste your body and feel your weight on me...)~
== TICher ~Do you want to...?~
END
++ ~Oh gods, yes!~ + n5m2
+~Gender(Player1,MALE)~+~Umm...Cherilane...I don't have a...Do you have any...~ DO ~SetGlobal("TICherSafe","GLOBAL",1)~ + n5m1a
++ ~*Pull her down on the bed.*~ + n5m2
...
CHAIN
IF ~~ THEN TICher n5m1a
~*She blushes.* Ummm.... Oh. Yes. Somewhere... *Cherilane rustles in a small bag, finally digging out a small vellum packet and a flask. She hands them to you with a flourish.* Here's what you need.~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(Cassil herb tea and a skin. You get ready and I'll loosen my clothing. *She unfastens the closure of her shirt, letting it fall onto the bed. Then, catlike, she stretches, the smooth curves of her breasts rising with her movements. All the while, she looks intently in your eyes and smiles.*)~
== TICher ~Ready now?~
END
++ ~Oh gods, yes!~ + n5m2
++ ~*Pull her down on the bed.*~ + n5m2
...
IF ~~ THEN TICher n5m2
~Sweet Sharess!~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(*Cherilane slim, lithe body falls into bed with you. For a moment, the pair of you tumble together and fumble at each other's clothing.*)~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(*Cherilane unties your laces, sliding her hand down into your breeches. Her hand moves rapidly, caressing you intimately, until you moan with desire.*)~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(Oh <CHARNAME>... Yes, touch me... Oh gods above... You feel so good to me...)~
END
...
CHAIN
IF ~Global("TICheril","GLOBAL",6)~ THEN TICher w1
~Good day, ladies and gentlemen. May I present to you a poem by Baran:~
== TICher ~'How do I love thee? Let me count the ways.
...
CHAIN
IF ~~ THEN TICher w1_01
~Oh! <CHARNAME>! It's you! I'm a bit surprised to see you here. *Smiles.* Although I am delighted as well.~
END
...
CHAIN
IF ~~ THEN TICher w1a1
~Ugh. It's bad enough to see it once, but I've seen it dozens of time. Any of us who get too close get sprayed with ogre gore! I was once in the middle of a ballad and got blood in my mouth... Yuck!~
END
IF ~~ THEN + w1a1_01

CHAIN
IF ~~ THEN TICher w1a2
~You... you WANT to see an ogre explode? Ick. I guess you get used to gore if you're an adventurer.~
END
IF ~~ THEN + w1a1_01

CHAIN
IF ~~ THEN TICher w1a3
~I'm glad someone else thinks it's nasty. Have you ever seen a spleen up close? Oh... yes, I guess you have. Anyway, it's disgusting.~
END
IF ~~ THEN + w1a1_01

CHAIN
IF ~~ THEN TICher w1a4
~It's kind of hard, actually. Maybe Candlekeep's peaceful atmosphere spoiled me for normal bardic work. Of course, getting sprayed with ogre flesh repeatedly every day bothers me greatly.~
END
IF ~~ THEN + w1a1_01

CHAIN
IF ~~ THEN TICher w1a5
~You sound like my boss. I made the mistake once of asking to work in a different area from Oopah. He told me that when I make more money than Oopah, I can pick my favorite spot. If I complain again, he'd reassign me to wander like Lord Binky. Ugh!~
END
IF ~~ THEN + w1a1_01

CHAIN
IF ~~ THEN TICher w1a1_01
~*Cherilane casts a nervous glance behind her.* I shouldn't say anything negative about it. It draws large crowds, I'm afraid. My boss particularly likes it, too. But enough about that. How have you been doing?~
END
...
CHAIN
IF ~~ THEN TICher w2a
~*Cherilane tilts her head and looks keenly at you.* I'm glad you feel that way. I admit I've spent much of my time thinking about the past.~
END
...
CHAIN
IF ~~ THEN TICher w2b
~Assassins! And here I am, complaining about Oopah!? Does Gorion know?~
END
...
CHAIN
IF ~~ THEN TICher w2c
~By all the gods! Do you know who the killers were?~
END
...
CHAIN
IF ~~ THEN TICher w3e
~I sense that something truly bad has happened to him. But, if you don't want to discuss it, that's fine with me. I'm sorry that you're hurting.~
END
IF ~~ THEN + w3e_01

CHAIN
IF ~~ THEN TICher w2f
~I know that I can never make up for the loss of Gorion in your life with mere words, but I do want to say that I had a lot of affection and respect for the man. You should cherish the good memories you have.~
END
IF ~~ THEN + w3e_01

CHAIN
IF ~~ THEN TICher w3e_01
~I want you to know that I'm here for you. There may not be much I can do, but I'll do what I can for you! *Sigh.* I admit I've spent much of my time lately thinking about the past.~
END
+~Global("TICherKissed","GLOBAL",1)~+ ~Me, too. I especially remember that last kiss.~ + w3a
+~Global("TICherSex","GLOBAL",1)~+ ~Me, too. I've missed the feel of your body.~ + w3a
++ ~Me, too. Everything I've done seems to have consequences, you know?~ + w3c
...
CHAIN
IF ~~ THEN TICher w3a
~*Blushing.* You make me wish I had my own, separate quarters. I'd love to spend a few moments with you before the road draws you away from me again. But the only place where I can get away from the gruesome reality of work is to go into the Black Lotus tent.~
END
...
CHAIN
IF ~~ THEN TICher w4a
~No, of course not... Not usually, anyway. I only go in there when a customer wants me to sing them to 'sleep,' so to speak. And then sometimes they want me to have some, too. Weirdly, it's kind of peaceful. But I shouldn't have brought that up. I guess we should say our goodbyes here...~
END
...
CHAIN
IF ~~ THEN TICher w4c
~Well, then, <CHARNAME>, I guess we must say our goodbyes.~
END
++ ~I guess so. Come here and give me a kiss...~ + w5a
++ ~Sounds like somebody needs a hug...~ + w5b
++ ~*Offer your hand for a handshake.* Put 'er there!~ + w5c
...
CHAIN
IF ~~ THEN TICher w3c
~Oh yes. That's an important lesson. That which has gone before always affects our present life. Ugh. I have to get back to work.~
END
IF ~~ THEN + w3c_01

CHAIN
IF ~~ THEN TICher w3d
~Hmmm. The future. I guess that's a lesson I should learn as well. If I forget about having seen Oopah's innards fifty thousand times and focus instead on the future, then I might not be as bothered about having to stand next to him.~
END
IF ~~ THEN + w3c_01

CHAIN
IF ~~ THEN TICher w3c_01
~Come here, <CHARNAME>. We're no longer student and teacher. Would it be okay for me to give you a kiss?~
END
++ ~I'd like that.~ + w5a
...
CHAIN
IF ~~ THEN TICher w5a
~I wish I had someplace for us to go. *Cherilane gently kisses you on the forehead, then, the lips.*~
== TICher IF ~Global("C#LC_Description","GLOBAL",1)~ THEN ~(*Her touch is light, but intense. As she kisses you, her hands clasp you tightly to her, her body yearning for you.*)~
== TICher ~No, sweet <CHARNAME>, I'll just have to wait for the future to bring you back to me. But not here. I'm done with exploding ogres. I'm going to go talk to the Carnival boss. Farewell.~
END
IF ~~ THEN DO ~SetGlobal("TICherKissed","GLOBAL",1) EscapeArea()~ EXIT

CHAIN
IF ~~ THEN TICher w5b
~Oh, sweet <CHARNAME>, I'll just have to wait for the future to bring you back to me. *Cherilane takes you in her arms and gives you a firm body hug.*~
== TICher IF ~Global("C#LC_Description","GLOBAL",1)~ THEN ~(*In her embrace, you can sense her yearning for more. But, before you pull away, she gently kisses you on the lips.*)~
== TICher ~But not here. I'm done with exploding ogres. I'm going to go talk to the Carnival boss. Farewell.~
END
IF ~~ THEN DO ~SetGlobal("TICherKissed","GLOBAL",1) EscapeArea()~ EXIT
...
IF ~~ THEN BEGIN w5c
SAY~*Cherilane laughs, takes your hand, and pulls you into a firm body hug.* Oh, sweet <CHARNAME>, I'll just have to wait for the future to bring you back to me. But not here. I'm done with exploding ogres. I'm going to go talk to the Carnival boss. Farewell.~
IF ~~ THEN DO ~EscapeArea()~ EXIT
END
...
SAY~*Cherilane takes you in her arms and gently pulls you down onto an empty pallet.* I've just missed you terribly. That's all. I've dreamt about touching you... holding you...~
...
CHAIN
IF ~~ THEN TICher t2c2
~*Cherilane returns your kisses warmly.*~
== TICher IF ~Global("C#LC_Description","GLOBAL",1)~ THEN ~(*Her hands start to rove up and down your body, caressing, squeezing, and stroking.*)~
== TICher ~Oh darling, I long to feel your bare skin against mine, but not here. Not now. Let us just be together for a few moments.~
END
+~Gender(Player1,MALE)~+ ~It can be better than this. We can do more. We don't have to get completely undressed.~ + t2c1am
+~Gender(Player1,FEMALE)~+ ~It can be better than this. We can do more. We don't have to get completely undressed.~ + t2c1af
++ ~Yes. This is very peaceful.~ + t2c1b
...
CHAIN
IF ~~ THEN TICher t2c1am
~*Cherilane looks deeply into your eyes.* I'll confess... I'm not prepared. But I want you so much... Can you be careful?~
END
++ ~Yes.~ + t2c1am.1
...
CHAIN
IF ~~ THEN TICher t2c1am.1
~*Cherilane smiles wickedly, but says nothing. Instead, she lets her hands express her desire for you.~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(*Caressing, kissing, and clasping each other tightly, you make the most of your circumstances. The friction of your bodies against each other and the dextrous movements of your fingers shoving aside clothing as needed permit a pleasure heightened by the sense of being watched.*)~
== TICher ~Gods, this is delicious, <CHARNAME>. Don't stop... I hear Tyelde's lines:~
...
CHAIN
IF ~~ THEN TICher t2c1af
~*Cherilane smiles wickedly, but says nothing. Instead, she lets her hands express her desire for you.~
== TICher IF ~Global("C#LC_Details","GLOBAL",1)~ THEN ~(*Caressing, kissing, and clasping each other tightly, you make the most of your circumstances. The friction of your bodies against each other and the dextrous movements of your fingers shoving aside clothing as needed permit a pleasure heightened by the sense of being watched.*)~
== TICher ~Gods, this is delicious, <CHARNAME>. Don't stop... I hear Teli's lines:~
...
CHAIN
IF ~Global("TICheriTentAfterTalk","LOCALS",1) Global("TICherEndTent","GLOBAL",0)~ THEN TICher t4
~*After your mutual pleasure, Cherilane holds you close.* Oh, <CHARNAME>, I don't want to let you go, but our time has once again drawn to a close...~
== TICher IF ~Global("C#LC_Description","GLOBAL",1)~ THEN ~(*The two of you stand up, adjusting and brushing dust from each others' clothing. Cherilane kisses you once more.*)~
== TICher ~Farewell, my sweet. May the gods let us meet again when we can be together.~
END
...
++ ~Take this gold, then. Are you sure you don't need an escort? We'd be happy to do it.~ DO ~TakePartyGold(10)~ + t5
END
...
CHAIN
IF ~~ THEN TICher y1e1b
~Very well.~
== TICher IF ~Global("C#LC_Description","GLOBAL",1)~ THEN ~(*Cherilane sits on the bed with you. You pop open a bottle of healing potion, pouring it in her palms so that she can apply it wherever she likes. As the bruises and gouges fade to nothingness, Cherilane sighs softly.*)~
== TICher ~That's a welcome relief.~
END
IF ~~ THEN + y1e1a_01

CHAIN
IF ~~ THEN TICher y1e1c
~Very well.~
== TICher IF ~Global("C#LC_Description","GLOBAL",1)~ THEN ~(*Cherilane sits on the bed with you. You open a packet of powdered healing herbs, mixing it with some water, and pouring the resulting liquid into her palms so that she can apply it however she likes. As the bruises and gouges fade to nothingness, Cherilane sighs softly.*)~
== TICher ~That's a welcome relief.~
END
IF ~~ THEN + y1e1a_01
...
SAY~Who is the father? *Cherilane looks intently at you.* I hope that it's yours. By all rights, this shouldn't even have happened. You're the only one I love, <CHARNAME>. But I can't know for sure. Not unless the baby looks like you... Oh, <CHARNAME>... They force-fed me Black Lotus in the mines... It takes away so many memories. Canticle wishes to claim the baby. He swears that we were lovers before you and I were reunited at Nashkel Fair... But how could I forget something like that?~
IF ~~ THEN + z1a1a2_01
END

IF ~~ THEN BEGIN z1a1a3a
SAY~Who's the father? *Cherilane looks away.* You're the only one I love, <CHARNAME>. I wish it were possible that it was your child. Because it's terrible not to know for sure. Oh, <CHARNAME>... They force-fed me Black Lotus in the mines... It takes away so many memories. Canticle wishes to claim the baby. He swears that we were lovers before you and I were reunited at Nashkel Fair... But how could I forget something like that?~
IF ~~ THEN + z1a1a2_01
END

IF ~~ THEN BEGIN z1a1a3b
SAY~*Cherilane looks away.* By all rights, this shouldn't even have happened. You're the only one I love, <CHARNAME> and the only one I remember making love to. I wish it were possible that it was your child. Because it's terrible not to know for sure. Oh, <CHARNAME>... They force-fed me Black Lotus in the mines... It takes away so many memories. Canticle wishes to claim the baby. He swears that we were lovers before you and I were reunited at Nashkel Fair... But how could I forget something like that?~
IF ~~ THEN + z1a1a2_01
END
